...
import { Calendar, Clock, Phone, MessageSquare, Brain, Zap, CheckCircle, ArrowRight, Cpu, Mic, FileText, Clock as ClockIcon, Users, TrendingUp } from 'lucide-react';
      ...
      <article className="w-full px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">How AI Receptionists Work: At a Glance</h2>
        ...
        >
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            ...
            <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Initial Setup</h3>
              <p className="mb-3">
        ...
        <motion.section
          ...
          className="mb-16"
        >
          <div className="bg-white border-2 border-blue-200 rounded-2xl p-8 text-center">
