...
const BestAIReceptionistHomeServices: React.FC = () => {
  ...
  useEffect(() => {
    ...
    updateMetaDescription(
      'Best AI receptionist for home services in 2026. Capture every call for plumbers, HVAC, roofing, and contractors. 24/7 answering, lead qualification, and booking.'
    );
