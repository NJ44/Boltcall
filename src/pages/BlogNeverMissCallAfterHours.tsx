...
import { Calendar, Clock, Phone, PhoneOff, Zap, CheckCircle, XCircle, Moon, ArrowRight } from 'lucide-react';
        ...
        <div className="flex gap-8">
          <article className="flex-1 max-w-4xl">
            ...
            <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-16" id="why-after-hours-calls-cost-you">
              ...
              <img src="/images/blog/never-miss-call-after-hours-01-why-afterhours-calls-are-costing-you-more-than-yo.svg" alt="Why After-Hours Calls Are Costing You More Than You Think" width={800} height={450} loading="lazy" className="rounded-xl my-8 w-full" />
            </motion.section>
            ...
            <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-16" id="what-customers-expect-after-hours">
              ...
              <img src="/images/blog/never-miss-call-after-hours-02-what-customers-actually-expect-when-they-call-afte.svg" alt="What Customers Actually Expect When They Call After Hours" width={800} height={450} loading="lazy" className="rounded-xl my-8 w-full" />
            </motion.section>
            ...
            <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-16" id="3-ways-businesses-handle-it-wrong">
              ...
              <img src="/images/blog/never-miss-call-after-hours-03-the-3-ways-most-businesses-handle-afterhours-call.svg" alt="The 3 Ways Most Businesses Handle After-Hours Calls Wrong" width={800} height={450} loading="lazy" className="rounded-xl my-8 w-full" />
            </motion.section>
            ...
            <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-16" id="what-a-good-after-hours-system-looks-like">
              ...
              <img src="/images/blog/never-miss-call-after-hours-04-what-a-proper-afterhours-call-system-looks-like.svg" alt="What a Proper After-Hours Call System Looks Like" width={800} height={450} loading="lazy" className="rounded-xl my-8 w-full" />
            </motion.section>
            ...
            <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-16" id="how-ai-receptionists-handle-after-hours-calls">
              ...
              <img src="/images/blog/never-miss-call-after-hours-05-how-ai-receptionists-handle-afterhours-calls-diff.svg" alt="How AI Receptionists Handle After-Hours Calls Differently" width={800} height={450} loading="lazy" className="rounded-xl my-8 w-full" />
            </motion.section>
            ...
            <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-16" id="after-hours-call-setup-by-industry">
              ...
              <img src="/images/blog/never-miss-call-after-hours-06-afterhours-call-setup-by-industry-real-examples.svg" alt="After-Hours Call Setup by Industry (Real Examples)" width={800} height={450} loading="lazy" className="rounded-xl my-8 w-full" />
            </motion.section>
            ...
            {/* CTA */}
            <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-16 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 md:p-12 text-white">
              <div className="flex items-center gap-3 mb-4"><PhoneOff className="w-8 h-8 text-blue-200" /></div>
              <h2 className="text-2xl md:text-3xl font-bold mb-4">Stop Losing Leads After Hours</h2>
              <p className="text-blue-100 text-lg mb-8 max-w-2xl">Boltcall's AI receptionist answers every call — day or night — qualifies the lead, books the appointment, and sends you a full summary. Set up in under 24 hours. No staff required.</p>
              <Link to="/ai-receptionist" className="inline-flex items-center gap-2 bg-white text-blue-600 px-8 py-4 rounded-xl font-semibold hover:bg-blue-50 transition-colors">
