...
const PaymentPro: React.FC = () => {
  ...
  useEffect(() => {
    ...
    script.src = 'https://www.paypal.com/sdk/js?client-id=AVXyY8XYUdjXN2OlWxF47bXfY0ALk--3yp1gyP_oQGncuqDSsqNvL9giHPQGb7hfuuALO7tH-UhHof7R&components=hosted-buttons&disable-funding=venmo&currency=USD';
    ...
    script.onload = () => {
      if (window.paypal) {
        window.paypal.HostedButtons({
          hostedButtonId: "FUL2XPWPEMFUY"
        }).render("#paypal-container-FUL2XPWPEMFUY");
      }
    };
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Pro Plan</h1>
          <p className="text-xl text-gray-600">Perfect for growing dental practices</p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="bg-blue-50 rounded-lg p-4 mb-6">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                <li>• Up to 500 leads per month</li>
                <li>• Advanced AI conversation flows</li>
          ...
          >
            ...
            <div className="mb-6">
              <div id="paypal-container-FUL2XPWPEMFUY" className="flex justify-center"></div>
            </div>
