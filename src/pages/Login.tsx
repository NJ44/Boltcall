    ...
    <div className="min-h-screen bg-zinc-50">
      <div className="max-w-7xl mx-auto">
        <div className="min-h-screen flex">
          ...
          {/* Right Panel - Blue Background with Login Form */}
          <div className="w-full lg:w-1/2 bg-blue-600 flex items-center justify-center p-6">
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-md hover:border-gray-400 hover:shadow-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed group"
              >
