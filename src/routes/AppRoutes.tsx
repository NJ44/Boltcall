...
const BlogAIReceptionistChiropractors = React.lazy(() => import('../pages/BlogAIReceptionistChiropractors'));
  ...
  return (
    <Suspense fallback={null}>
      <Routes>
        ...
        <Route path="/blog/ai-receptionist-for-chiropractors" element={<BlogAIReceptionistChiropractors />} />
        </Route>
