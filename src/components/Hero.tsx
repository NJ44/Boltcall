      ...
      >
        ...
        <div className="flex justify-center mb-6 relative z-10">
          <div className="flex gap-4 flex-col items-center w-full max-w-4xl mx-auto">
            <h1 className="text-3xl md:text-5xl lg:text-6xl max-w-4xl tracking-tighter font-bold text-text-main flex items-center justify-end md:justify-center gap-1 md:gap-2 flex-nowrap md:ml-56 px-4 md:px-0">
              <motion.span
