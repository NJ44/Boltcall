          ...
          <div className="relative z-10 text-center pt-24 md:pt-16 lg:pt-20">
            ...
            <div className="flex justify-center mb-6 relative z-10">
              <div className="flex gap-4 flex-col items-center w-full max-w-4xl mx-auto">
                <h1 className="text-3xl md:text-5xl lg:text-6xl max-w-4xl tracking-tighter font-bold text-text-main flex items-center justify-center gap-1 md:gap-2 flex-nowrap ml-[36px] md:ml-56 scale-110 md:scale-100">
                  <motion.span
