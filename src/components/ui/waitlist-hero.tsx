      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 animate-spin-slow">
            ...
            >
              <Phone className="w-[120px] h-[120px] text-blue-500/40" strokeWidth={1.5} />
            </div>
          </div>

          {/* Icon 2 - MessageSquare / SMS (Top Right) */}
          <div className="absolute inset-0 animate-spin-slow-reverse">
            ...
            >
              <MessageSquare className="w-[100px] h-[100px] text-green-500/40" strokeWidth={1.5} />
            </div>
          </div>

          {/* Icon 3 - Mail (Bottom Left) */}
          <div className="absolute inset-0 animate-spin-slow">
            <div
              className="absolute flex items-center justify-center"
              style={{
            ...
            >
              <Mail className="w-[110px] h-[110px] text-purple-500/40" strokeWidth={1.5} />
            </div>
          </div>

          {/* Icon 4 - Video (Bottom Right) */}
          <div className="absolute inset-0 animate-spin-slow-reverse">
            <div
              className="absolute flex items-center justify-center"
              style={{
            ...
            >
              <Video className="w-[105px] h-[105px] text-pink-500/40" strokeWidth={1.5} />
            </div>
          </div>

          {/* Icon 5 - Calendar (Center Left) */}
          <div className="absolute inset-0 animate-spin-slow">
            <div
              className="absolute flex items-center justify-center"
              style={{
            ...
            >
              <Calendar className="w-[95px] h-[95px] text-orange-500/35" strokeWidth={1.5} />
            </div>
          </div>

          {/* Icon 6 - Camera (Center Right) */}
          <div className="absolute inset-0 animate-spin-slow-reverse">
            <div
              className="absolute flex items-center justify-center"
              style={{
            ...
            >
              <Camera className="w-[100px] h-[100px] text-cyan-500/35" strokeWidth={1.5} />
            </div>
          </div>
        </div>
        ...
        <div className="relative z-20 w-full h-full flex flex-col items-center justify-end pb-24 gap-6">
          <div className="w-16 h-16 rounded-2xl shadow-lg overflow-hidden mb-2 ring-1 ring-white/10 bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
