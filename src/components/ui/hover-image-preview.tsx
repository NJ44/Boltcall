...
/**
 * Preview data for Boltcall features
 * Titles match the exact hero headings from the linked pages
 */
const previewData = {
  figma: {
    image: "https://images.unsplash.com/photo-1551434678-e076c223a692?w=560&h=320&fit=crop",
    title: "Never Miss a Call with AI Receptionist",
    subtitle: "Your AI receptionist answers calls 24/7, schedules appointments, and provides instant support",
    href: "/features/ai-receptionist",
  },
  sketch: {
    image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=560&h=320&fit=crop",
    title: "Turn Form Submissions into Instant Conversations",
    subtitle: "Automatically respond to every form submission within seconds, qualify leads, and book appointments",
    href: "/features/instant-form-reply",
  },
  adobe: {
    image: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=560&h=320&fit=crop",
    title: "Engage Visitors with AI Chat & Voice",
    subtitle: "Add an intelligent chat and voice widget to your website that answers questions and captures leads 24/7",
    href: "/features/website-chat-voice-widget",
  },
}
 ...
 * HoverLink Component
 * 
 * A text link that triggers preview on hover and navigates to pages
 * 
 ...
 * - Blue gradient hover effect on links
 ...
 * - Change blue gradient colors in .hover-link::after
 */
  ...
  return (
    <>
      <style>{`
        ...
        /* Hover link styles with blue gradient */
        .hover-link {
          color: #ffffff;
          font-weight: 700;
          cursor: pointer;
        ...
        <div className="content-container">
          <div className="text-block">
            <p>
              ...
              that answers calls, schedules appointments, and provides instant support 24/7.
            </p>
            <p>
              Turn form submissions into instant conversations with{" "}
              <HoverLink
                previewKey="sketch"
                href={previewData.sketch.href}
                onHoverStart={handleHoverStart}
                onHoverMove={handleHoverMove}
                onHoverEnd={handleHoverEnd}
              >
              ...
              or engage visitors directly on your website with our{" "}
              <HoverLink
                previewKey="adobe"
                href={previewData.adobe.href}
                onHoverStart={handleHoverStart}
                onHoverMove={handleHoverMove}
                onHoverEnd={handleHoverEnd}
              >
