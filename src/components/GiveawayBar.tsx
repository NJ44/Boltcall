...
const GiveawayBar: React.FC = () => {
  return (
    <Link to="/challenge" className="block">
      <div className="bg-blue-600 text-white fixed top-14 left-0 right-0 z-50 cursor-pointer shadow-none drop-shadow-none ring-0 border-none outline-none" style={{ minHeight: '43px', contain: 'layout style', boxShadow: 'none' }}>
