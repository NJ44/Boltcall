-- Combined SQL Schema for Callbacks and Chats Tables
...
-- Enable Row Level Security for callbacks
ALTER TABLE callbacks ENABLE ROW LEVEL SECURITY;

-- Create RLS policies for callbacks
...
-- Add constraints for chats
ALTER TABLE chats ADD CONSTRAINT valid_chat_status 
  CHECK (status IN ('active', 'paused', 'closed', 'transferred', 'abandoned'));

ALTER TABLE chats ADD CONSTRAINT valid_chat_priority 
